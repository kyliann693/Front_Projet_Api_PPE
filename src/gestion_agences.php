    ...
    <div class="flex">
            <div class="container">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item active"><a href="gestion_agences.php"><i class="fas fa-play "></i><span class="menu-text">Gestion des agences</span></a></li>
            ...
            <section class="section_table">
                <button class="button_add open-button" type="submit" class="btn btn-success mb-3" onclick="openForm()">Ajouter des agences</button>
                <table>
                    <tr>
                        <th>Agences</th>
                        <th>Modifier</th>
