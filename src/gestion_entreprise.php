    ...
    <div class="flex">
            <div class="container">
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item active"><a href="gestion_entreprise.php"><i class="fas fa-user"></i><span class="menu-text">Gestion entreprise</span></a></li>
            ...
            <section class="section_table">
                <button class="button_add open-button" type="submit" class="btn btn-success mb-3" onclick="openForm()">Ajouter une entreprise</button>
                <table>
                    <tr>
                        <th>Entreprise</th>
                        <th>Modifier</th>
